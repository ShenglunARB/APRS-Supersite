...
def timezone_correction(df_daily, site):
    ...
    elif 'Bakersfield' in site:       
        mask = (df_daily.index < pd.to_datetime('2025-10-14 08:32:00')) &\
              (df_daily.index >= pd.to_datetime('2025-02-03 00:00:00'))
        df_daily.index += pd.Timedelta(hours=7, minutes=58) * mask      
...
if __name__ == "__main__":
    site = 'Bakersfield-California Ave Supersite' # 'Fresno-Garland Supersite', 'Berkersfield-CA Supersite', 'MWO'
    analyzer = 'AE33'
    #date = '2024-11-01'
    #main(site, analyzer, date, average_time='1min')

    dates = pd.date_range(start='2025-02-01', end='2025-10-14', freq='D')
